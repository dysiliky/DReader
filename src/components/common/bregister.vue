<template lang="html">
	...
	<div class="bLoginWaper registerBar">
		<!--<img src="../../../static/images/cancel.png" alt="" class="bexit" @click="bclose()">-->
    <div style="margin-top: 80px"></div>
		...
		<!-- 登录按钮 -->
		<mt-button type="primary" class="bRegisterBtn" style="background:#ffd900" @click.prevent="bRegister()">注册</mt-button>
		<!-- 登录遇到问题请联系管理员 -->
...
<style lang="css">
	* {
	...
	.blogo {
		background: url(../../../static/images/dr.png) no-repeat center;
