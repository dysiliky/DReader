		...
		<transition>
			<div class="sort animated" :class="{'isShow':show}">
				<transition-group enter-active-class="fadeInRight" tag="div">
					<div class="" :key="index" v-for="(item,index) in result">
						<div @click="changclass(item.classid,result[index].classname)" class="css animated">
              <img :id="item.classid" :class="'img' + [index]" :src="'http://p5tu13q99.bkt.clouddn.com/icon' + index + '.png'">
            </div>
					</div>
				</transition-group>
			</div>
