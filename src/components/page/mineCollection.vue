<template lang="html">
  <div id="mineCreate" :id="model">
    <mt-header title="个人收藏列表" style="background: #ffd900">
      <router-link to="/mine" slot="left">
        <mt-button icon="back">返回</mt-button>
      </router-link>
    </mt-header>
    <div class="parentCollection" :to="'/bdetailarticle/'+item.detailpageid" v-for="item in articlemodel"
         v-if="articlemodel" @click="showdetail(item.detailpageid)">
